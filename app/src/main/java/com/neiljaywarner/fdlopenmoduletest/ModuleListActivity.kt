...
import kotlinx.android.synthetic.main.module_list_content.view.*

import kotlinx.android.synthetic.main.module_list.*

/**
 * An activity representing a list of Pings. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a [ModuleDetailActivity] representing
...
class ModuleListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (module_detail_container != null) {
    ...
    class SimpleItemRecyclerViewAdapter(private val mParentActivity: ModuleListActivity,
        ...
        init {
            mOnClickListener = View.OnClickListener { v ->
                ...
                if (mTwoPane) {
                    val fragment = ModuleDetailFragment().apply {
                        arguments = Bundle()
                    ...
                    val intent = Intent(v.context, ModuleDetailActivity::class.java).apply {
                        putExtra(ModuleDetailFragment.ARG_ITEM_ID, item.id)
                    }
